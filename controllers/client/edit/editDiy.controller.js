...
const { mergeDiy } = require("../../../helper/merge-diy.js");
...
// ================== APPLY + MERGE ==================
module.exports.postEditDiy = async (req, res) => {
    try {
        ...
        // ====== MERGE ======
        const outputFileName = await mergeDiy(
            sourceDir,
            selectedFrame,
            frameType,
            PRINT_WIDTH,
    ...
    console.log(
        ...
        console.error("❌ postEditDiy error:", err);
        res.status(500).json({ success: false });
    }
};

// ================== RENDER EDIT PAGE ==================
module.exports.editDiy = (req, res) => {
