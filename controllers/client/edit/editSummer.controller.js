...
const { mergeSummer } = require("../../../helper/merge-summer.js");
...
// ================== APPLY + MERGE ==================
module.exports.postEditSummer = async (req, res) => {
    try {
        ...
        // ====== MERGE ======
        const outputFileName = await mergeSummer(
            sourceDir,
            selectedFrame,
            frameType,
            PRINT_WIDTH,
...
// ================== RENDER EDIT PAGE ==================
module.exports.editSummer = (req, res) => {
